...
import styles from "./FinancialsHeader.module.css";
import logo from "../../../assets/nebius/nebius-grey.svg";
import hamburger from "../../../assets/icons/hamburger-grey.svg";
import exit from "../../../assets/icons/nav-exit-grey.svg";
import timeline from "../../../assets/icons/timeline-grey.svg";
import finance from "../../../assets/icons/finance-grey.svg";
import contact from "../../../assets/icons/contact-grey.svg";
      ...
      <header className={styles.header}>
        ...
        <nav className={styles.nav}>
          <ul className={styles.navList}>
            <li>
              <Link to="/datacenter_timeline" className={styles.navButton}>Datacenter Timeline</Link>
            </li>
            <li>
              <Link to="/financials" className={styles.navButton}>Financials</Link>
            </li>
            <li>
              <button className={styles.navButton} onClick={() => setIsContactOpen(true)}>
                Contact
              </button>
            </li>
          </ul>
