...
const lines = ["ネビウス財務情報　nebius financials", "発生中　under development"];
    ...
    return (
        <div style={{
            ...
            {lines.map((line, i) => (
                <div key={i} style={{
                    opacity: 0,
                    animation: `fadeIn 0.6s cubic-bezier(0.22, 1, 0.36, 1) ${0.4 + i * 1.0}s forwards`
                }}>
...
<div style={{
    opacity: 0,
    animation: `fadeIn 0.6s cubic-bezier(0.22, 1, 0.36, 1) ${0.4 + lines.length * 1.0}s forwards`
}}>
    <span style={{ color: "rgba(30,50,70,0.25)", marginRight: "0.5rem" }}>//</span>
