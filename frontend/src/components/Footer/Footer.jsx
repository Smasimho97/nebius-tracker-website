        ...
        <div className={"constructorContainer"}>
          <div className={styles.footerContainer}>
            ...
            <div className={styles.disclaimer}>
              This is an independent information hub created by a Nebius
              investor and enthusiast. It is not officially affiliated with or endorsed by
              Nebius Group. All data is compiled from publicly available
              sources.
            </div>
          </div>
        </div>
